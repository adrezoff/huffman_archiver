...
class Compressor(CompressorABC):
    ...
    def __init__(self, codec=None, block_size=128):
        ...
        Параметры:
        - codec (str): Кодировка для чтения файлов.
        По умолчанию None.
    ...
    def compress(self, path_in, path_out):
        ...
        Возвращает:
        - int: Разница в размере между исходными данными и
        сжатыми данными.
        """
        size_path_in = 0
    ...
    def __bits_to_bytes(bits):
        ...
        - bytes_list (bytes):  байты полученные из битов.
        """
        bytes_list = []
    ...
    def __adder_zero(bits):
        ...
        Возвращает:
        - byte (bytes): байты полученные из битов с добавленными
        нулями.
    ...
    def __is_file(path):
        ...
        Возвращает:
        - bool: True, если путь указывает на файл, False в
        противном случае.
        """
