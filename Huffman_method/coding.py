...
def expand_key(master_key):
    ...
    return [key_columns[Nb * i: Nb * (i + 1)] for i in range(len(key_columns) // Nb)]
...
Nb = 4  # Количество столбцов состояния (фиксировано для AES)
Nr = 10  # Количество раундов шифрования (для AES-128)
